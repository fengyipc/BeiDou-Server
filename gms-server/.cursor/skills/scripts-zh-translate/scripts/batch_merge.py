#!/usr/bin/env python3
"""Merge Subagent translation results back into script-translation-memory.json (single-writer)."""
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Merge batch updates into script translation memory JSON.")
