#!/usr/bin/env python3
"""Export one batch of units (needsTranslation) from quest-translation-memory.json for parallel agents."""
...
DEFAULT_OUT_DIR = Path("tools/quest-wz-translate/batches")


def main() -> int:
    ap = argparse.ArgumentParser(description="Export a batch of pending translation units.")
