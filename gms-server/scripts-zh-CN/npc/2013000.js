        ...
        if (cm.getMapId() == 200080101) {
            if (status == 0) {
                ...
                if (selection == 0) {
                    ...
                    cm.sendOk("#e#b<女神之塔组队任务>#k#n\r\n我们的女神已经失踪了一段时间，有传言说她最后一次被看到是在女神之塔内。此外，我们的圣地已经被精灵们的压倒性力量夺取，这些生物最近一直在女神之塔的边缘徘徊。他们的领袖，远古精灵，目前掌握着王位，可能知道她的下落，因此我们迫切需要找到一支由勇敢的英雄组成的队伍，冲进去夺回我们的圣地并拯救她。如果你的团队能够包含每个职业（战士，魔法师，弓箭手，飞侠和海盗），你们将得到我的祝福来帮助你们战斗。你们会帮助我们吗？");
                    cm.dispose();
                } else {
                ...
                if (selection == 0) {
                    if (cm.canHold(1082232) && cm.haveItem(4001158, 20)) {
                        cm.gainItem(1082232, 1);
                        cm.gainItem(4001158, -20);
                        cm.sendOk("感谢你为救出女神做的贡献，手镯已经给你啦！");
                        cm.dispose();
                    } else {
                        cm.sendOk("你没有20个#t4001158#，或者装备栏没有空间，请检查一下吧。");
                        cm.dispose();
                    }
                }
            }
