...
function action(mode, type, selection) {
    ...
    if (status == 0 && mode == 1) {
        var selStr = "你好。我是神秘岛手艺最好的手套工匠。需要我帮你做点什么吗？#b"
        ...
        if (selectedType == 0) { //warrior glove
            var selStr = "战士手套？好的，要做哪一种？#b";
            var gloves = ["青铜暗影手套#k - 战士 Lv. 70#b", "锂矿暗影手套#k - 战士 Lv. 70#b", "黑暗影手套#k - 战士 Lv. 70#b",
                "马尔斯蓝拳套#k - 战士 Lv. 80#b", "马尔斯绿拳套#k - 战士 Lv. 80#b", "马尔斯红拳套#k - 战士 Lv. 80#b", "马尔斯黑拳套#k - 战士 Lv. 80#b"];
            for (var i = 0; i < gloves.length; i++) {
                selStr += "\r\n#L" + i + "# " + gloves[i] + "#l";
            }
            cm.sendSimple(selStr);
        } else if (selectedType == 1) { //bowman glove
            var selStr = "弓箭手手套？好的，要哪一个？#b";
            var gloves = ["蓝神眼手套#k - 弓箭手 Lv. 70#b", "黄金神眼手套#k - 弓箭手 Lv.70#b", "黑神眼手套#k - 弓箭手 Lv. 70#b",
                "红天使手套#k - 弓箭手 Lv. 80#b", "蓝天使手套#k - 弓箭手 Lv. 80#b", "绿天使手套#k - 弓箭手 Lv. 80#b", "黑天使手套#k - 弓箭手 Lv. 80#b"];
            for (var i = 0; i < gloves.length; i++) {
                selStr += "\r\n#L" + i + "# " + gloves[i] + "#l";
            }
            cm.sendSimple(selStr);
        } else if (selectedType == 2) { //mage glove
            var selStr = "魔法师手套？好的，要哪一个？#b";
            var gloves = ["褐战魂手套#k - 魔法师 Lv. 70#b", "蓝战魂手套#k - 魔法师 Lv. 70#b", "黑战魂手套#k - 魔法师 Lv.70#b",
                "魔力绿手套#k - 魔法师 Lv. 80#b", "魔力蓝手套#k - 魔法师 Lv.80#b", "魔力青手套#k - 魔法师 Lv. 80#b"];
            for (var i = 0; i < gloves.length; i++) {
                selStr += "\r\n#L" + i + "# " + gloves[i] + "#l";
            }
            cm.sendSimple(selStr);
        } else if (selectedType == 3) { //thief glove
            var selStr = "飞侠手套？好的，要哪一种？#b";
            var gloves = ["青铜名誉手套#k - 飞侠 Lv. 70#b", "银名誉手套#k - 飞侠 Lv.70#b", "黄金名誉手套#k - 飞侠 Lv.70#b",
                "德古拉蓝手套#k - 飞侠 Lv. 80#b", "德古拉紫手套#k - 飞侠 Lv.80#b", "马尔斯黑拳套#k - 飞侠 Lv. 80#b"];
            for (var i = 0; i < gloves.length; i++) {
                selStr += "\r\n#L" + i + "# " + gloves[i] + "#l";
            }
            cm.sendSimple(selStr);
