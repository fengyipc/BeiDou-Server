    ...
    if (status == 0) {
        ...
        if (current == 1 || current == 2) {
            ...
            if (cm.haveItem(omok1piece[selection], omokamount) && cm.haveItem(omok2piece[selection], omokamount) && cm.haveItem(4030009, 1)) {
                ...
                cm.sendNext("#b你准备好 #t" + omok[selection] + "##k了嘛? 嗯...给我材料，我就可以那么做。仔细听，你需要的材料将会是： #r" + omokamount + " #t" + omok1piece[selection] + "#, " + omokamount + " #t" + omok2piece[selection] + "#，1个#t" + 4030009 + "##k. 怪物们可能会时不时地掉落那些东西……");
