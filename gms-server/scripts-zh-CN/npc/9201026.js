        ...
        if (status == 0) {
            ...
            if (!cm.haveItem(4031367 + nanaLoc, 1)) {
                if (cm.isQuestCompleted(100401 + nanaLoc)) {
                    state = 1;
                    cm.sendAcceptDecline("你是不是把我给你的 #k#t4031367##k 弄丢了？好吧，我可以再给你一份，但你得重新完成上次我拜托你的事，可以吗？我需要你帮我带来 #r50 #t" + questItems[nanaLoc] + "#'s.#k");
                    ...
                    state = 0;
                    cm.sendAcceptDecline("你在找#k#t4031367#的#k吗？我可以分你一个，但你得帮我个忙，行吗？");
                }
            } else {
