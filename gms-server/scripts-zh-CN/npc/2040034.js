    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                if (cm.hasItem(4001201, 20) && cm.canHold(1022073, 1)) {
                    cm.gainItem(4001201, -20);
                    cm.gainItem(1022073, 1, true, true);
                    cm.sendOk("#v1022073#划痕眼镜已经发放到你的背包了，感谢你为玩具城做出的贡献！");
                    cm.dispose();
                } else {
                    cm.sendOk("你可能没有收集20个#v4001201#，或者背包装备栏没有足够的空间，请再确认一下！");
                    cm.dispose();
                }
            }
        }
