...
function action(mode, type, selection) {
    if (mode < 1) {  // disposing issue with stylishs found thanks to Vcoc
        ...
        if (status == 0) {
            cm.sendSimple("我是助理伯丽特。如果你碰巧有 #b#t5150000##k、#b#t5150010##k 或者 #b#t5151000##k，要不要让我来帮你改变发型呢？\r\n#L0#理发：#i5150000##t5150000##l\r\n#L1#理发：#i5150010##t5150010##l\r\n#L2#染发：#i5151000##t5151000##l");
        } else if (status == 1) {
            if (selection == 0) {
                beauty = 3;
                hairnew = Array();
                ...
                cm.sendYesNo("如果你使用#b#t5150000##k，你的发型将随机改变，还有机会获得连你都没想到过的全新实验性发型。你确定要使用 #b#t5150000##k 并真正改变你的发型吗？");
            } else if (selection == 1) {
                beauty = 1;
                hairnew = Array();
                if (cm.getPlayer().getGender() == 0) {
                ...
                cm.sendYesNo("如果你使用 #b#t5150010##k，你的发型将随机改变，还有机会获得连你都没想到过的全新实验性发型。你确定要使用 #b#t5150010##k 并真正改变你的发型吗？");
            } else if (selection == 2) {
                beauty = 2;
                haircolor = Array();
                ...
                cm.sendYesNo("如果你使用#b#t5151000##k，你的发色将随机改变。你仍然想用 #b#t5151000##k 来改变一下吗？");
            }
        } else if (status == 2) {
            cm.dispose();
            if (beauty == 1) {
                if (cm.haveItem(5150010) == true) {
                    ...
                    cm.sendOk("嗯……看起来你没有我们指定的会员卡……没有它我恐怕不能给你理发。很抱歉……");
                }
            } else if (beauty == 2) {
                if (cm.haveItem(5151000) == true) {
                    ...
                    cm.sendOk("嗯……看起来你没有我们指定的会员卡……没有它我恐怕不能给你染发。很抱歉……");
                }
            } else if (beauty == 3) {
