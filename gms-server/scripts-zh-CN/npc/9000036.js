...
//        }
        ...
        if (selectedType == 0) { //pendant refine
            ...
            var matQtySet = [[100,100,25, 100], [200, 50, 200, 10], [100, 5, 100, 50], [100, 3, 100, 50], [100, 6, 150, 75], [100, 6, 150, 75], [200, 10, 100, 100], [200, 8, 200, 100], [1, 1, 1]];
            var costSet = [1000000, 1500000, 1000000, 1000000, 1500000, 1500000, 2000000, 2000000, 5000000];
            ...
            var matQtySet = [[20, 20], [20, 20, 20], [20, 20, 20, 15, 3], [20, 20], [20, 20, 20], [20, 20, 20, 15, 3], [10, 3], [10, 3], [10, 3], [10, 3]];
            var costSet = [500000, 1000000, 1500000, 500000, 100000, 1500000, 2000000, 2000000, 2000000, 2000000];
        } else if (selectedType == 2) { //eye accessory refine 1022088, 1022103
            var matSet = [[4001005, 4011008], [1022088, 4001005, 4011008], [1022103, 4001005, 4011008, 4000082]];
            var matQtySet = [[3, 2], [1, 4, 3], [1, 5, 3, 10]];
            var costSet = [1500000, 2000000, 3000000];
...
//        } else if (selectedType == 4) { //ring refine
            ...
            var matQtySet = [[50, 50, 20], [50, 50, 20], [1, 1], [1, 1], [3, 10], [1, 10], [1, 3]];
            var costSet = [500000, 500000, 1000000, 1000000, 1500000, 3000000, 5000000];
