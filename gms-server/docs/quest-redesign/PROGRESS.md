...
| Phase 1   | 金银岛副线 XML 实施（parent/order 字段修改）           | **进行中**（副线 1～10 除文档排除项外已实施：含副线 5 新建 2265、副线 7 Check 链、副线 9 parent、副线 10 含 30041/30042） | wz-zh-CN/Quest.wz/                                 |
...
| ------------ | ------------------ | ---------- |
| **新建**       | 记忆者的发现             | 主线衔接       |
| **30041**    | 她的名字               | 副线10·废都居民  |
| **30042**    | 最后的温暖              | 副线10·废都居民  |
| **2265**     | 蘑菇信号的源头            | 副线5·林中之城传说 |
